<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="center" width="558rpx" :popup="false" v-model="popupValue" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
...
<!--				</view>-->
			...
			<view class="u-picker-body">
				...
				<picker-view v-else-if="mode == 'multiSelector'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
      			...
      			<view class="u-picker-footer" @touchmove.stop.prevent="">
      				<view
      					class="u-btn-picker u-btn-picker--primary"
      					:style="{ color: moving ? cancelColor : confirmColor }"
      					@touchmove.stop=""
...
.uni-picker-view-indicator:before,.uni-picker-view-indicator:after{
  border-color: #C5CACF;
}
.u-text {
	font-size: 24rpx;
