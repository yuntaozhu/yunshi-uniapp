<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="center" width="558rpx" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
